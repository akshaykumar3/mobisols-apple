...
public class OwnerType implements java.io.Serializable {
	 ...
	 * @param lastModifiedeOn the last modifiede on
	...
	/**
	 * Gets the owner type id.
	 *
	 * @return the owner type id
	 */
	...
	/**
	 * Sets the owner type id.
	 *
	 * @param ownerTypeId the new owner type id
	 */
	...
	/**
	 * Gets the last modifiede on.
	 *
	 * @return the last modifiede on
	 */
	...
	/**
	 * Sets the last modifiede on.
	 *
	 * @param lastModifiedeOn the new last modifiede on
	 */

...
public class VmlType implements java.io.Serializable {
	 ...
	 */
	public VmlType(Integer vmlTypeId, String name, Integer lastModifiedBy,
	 ...
	 */
	public VmlType(Integer vmlTypeId, String name, String description,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VmlType))
			return false;
		VmlType castOther = (VmlType) other;

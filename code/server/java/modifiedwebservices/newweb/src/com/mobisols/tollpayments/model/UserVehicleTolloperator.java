...
/**
 * The Class UserVehicleTolloperator.
 */
public class UserVehicleTolloperator {
	
	/** The uvt id. */
	private Integer uvtId;
	 ...
	 * Sets the uvt id.
	 *
	 * @param uvtId the new uvt id
	 */
	public void setUvtId(Integer uvtId) {
		this.uvtId = uvtId;
	}
	...
	/**
	 * Gets the tolloperator id.
	 *
	 * @return the tolloperator id
	 */
	public Integer getTolloperatorId() {
		return tolloperatorId;
	}
	
	/**
	 * Sets the tolloperator id.
	 *
	 * @param tolloperatorId the new tolloperator id
	 */

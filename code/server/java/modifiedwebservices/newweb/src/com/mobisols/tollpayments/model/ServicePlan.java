...
public class ServicePlan implements java.io.Serializable {
	 ...
	 */
	public ServicePlan(Integer servicePlanId, String name,
	 ...
	 */
	public ServicePlan(Integer servicePlanId, Integer tollOperatorId,
	 ...
	 *
	 * @param servicePlanId the new service plan id
	 */
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ServicePlan))
			return false;
		ServicePlan castOther = (ServicePlan) other;

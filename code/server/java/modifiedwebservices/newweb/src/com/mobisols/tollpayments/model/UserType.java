...
public class UserType implements java.io.Serializable {
	 ...
	 * @param minBalanceType the min balance type
	 * @param udf1 the udf1
	 * @param udf2 the udf2
	 * @param udf3 the udf3
	 * @param udf4 the udf4
	...
	/**
	 * Gets the min balance type.
	 *
	 * @return the min balance type
	 */
	...
	/**
	 * Sets the min balance type.
	 *
	 * @param minBalanceType the new min balance type
	 */

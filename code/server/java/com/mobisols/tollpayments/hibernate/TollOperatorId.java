...
/**
 * TollOperatorId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class TollOperatorId extends GlobalToll implements java.io.Serializable {
	...
	/** default constructor */
	public TollOperatorId() {
	}

	/** minimal constructor */
	public TollOperatorId(Integer tollOperatorId, String name, String isActive,
	...
	/** full constructor */
	public TollOperatorId(Integer tollOperatorId, Integer userId, String name,
			String isActive, String website, String udf1, String udf2,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TollOperatorId))
			return false;
		TollOperatorId castOther = (TollOperatorId) other;

		return ((this.getTollOperatorId() == castOther.getTollOperatorId()) || (this
				.getTollOperatorId() != null
				&& castOther.getTollOperatorId() != null && this
				.getTollOperatorId().equals(castOther.getTollOperatorId())))

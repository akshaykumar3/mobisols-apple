...
public class ComponentVersionId implements java.io.Serializable {
	...
	/** minimal constructor */
	public ComponentVersionId(Integer compVersionId, Timestamp createdOn,
	...
	/** full constructor */
	public ComponentVersionId(Integer compVersionId, Integer componentId,
	...
	@Column(name = "comp_version_id", nullable = false)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ComponentVersionId))
			return false;
		ComponentVersionId castOther = (ComponentVersionId) other;

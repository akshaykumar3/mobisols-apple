...
/**
 * AbstractOwnerTypeAll entity provides the base persistence definition of the
 * OwnerTypeAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractOwnerTypeAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractOwnerTypeAll() {
	}

	/** minimal constructor */
	public AbstractOwnerTypeAll(UserAll userAll, String name,
	...
	/** full constructor */
	public AbstractOwnerTypeAll(ClientAll clientAll, UserAll userAll,
			String name, String description, String udf1, String udf2,
			String udf3, String udf4, String udf5, String falg1, String flag2,

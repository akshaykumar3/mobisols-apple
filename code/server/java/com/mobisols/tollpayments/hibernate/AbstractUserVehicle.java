...
/**
 * AbstractUserVehicle entity provides the base persistence definition of the
 * UserVehicle entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractUserVehicle extends GlobalToll implements
	...
	/** default constructor */
	public AbstractUserVehicle() {
	}

	/** full constructor */
	public AbstractUserVehicle(UserVehicleId id) {
		this.id = id;
	}

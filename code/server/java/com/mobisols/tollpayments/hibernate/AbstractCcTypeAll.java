...
/**
 * AbstractCcTypeAll entity provides the base persistence definition of the
 * CcTypeAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractCcTypeAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractCcTypeAll() {
	}

	/** minimal constructor */
	public AbstractCcTypeAll(UserAll userAll, Timestamp createdOn,
	...
	/** full constructor */
	public AbstractCcTypeAll(ClientAll clientAll, UserAll userAll, String name,
	...
	@Column(name = "cc_type_id", unique = true, nullable = false)
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "ccTypeAll")

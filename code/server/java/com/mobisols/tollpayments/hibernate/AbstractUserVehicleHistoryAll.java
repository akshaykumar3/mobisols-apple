...
/**
 * AbstractUserVehicleHistoryAll entity provides the base persistence definition
 * of the UserVehicleHistoryAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractUserVehicleHistoryAll extends GlobalToll
	...
	/** default constructor */
	public AbstractUserVehicleHistoryAll() {
	}

	/** minimal constructor */
	public AbstractUserVehicleHistoryAll(Integer userId, Integer vehicleTypeId,
	...
	/** full constructor */
	public AbstractUserVehicleHistoryAll(Integer userVehicleId, Integer userId,

...
/**
 * AbstractUserServiceAll entity provides the base persistence definition of the
 * UserServiceAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractUserServiceAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractUserServiceAll() {
	}

	/** minimal constructor */
	public AbstractUserServiceAll(UserAll userAllByLastModifiedBy,
	...
	/** full constructor */
	public AbstractUserServiceAll(ClientAll clientAll,
			UserAll userAllByLastModifiedBy, UserAll userAllByUserId,
			ServicePlanAll servicePlanAll, Timestamp startDate,
			Timestamp endDate, Integer priority, String udf1, String udf2,

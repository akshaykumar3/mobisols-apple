...
/**
 * TollLocationHistoryAll entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "toll_location_history_all", catalog = "globaltoll")
public class TollLocationHistoryAll implements java.io.Serializable {
	...
	/** default constructor */
	public TollLocationHistoryAll() {
	}

	/** minimal constructor */
	public TollLocationHistoryAll(Integer tollOperatorId, String geometry,
	...
	/** full constructor */
	public TollLocationHistoryAll(Integer tollLocationId,

...
/**
 * UserHistoryAll entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "user_history_all", catalog = "globaltoll")
public class UserHistoryAll implements java.io.Serializable {
	...
	/** default constructor */
	public UserHistoryAll() {
	}

	/** minimal constructor */
	public UserHistoryAll(String userName, Integer utypeId, String action,
	...
	/** full constructor */
	public UserHistoryAll(Integer userId, String userName, String password,
			String locale, Integer utypeId, Timestamp lastLoginTime,
			String isActive, String contactNo, Integer clientId, String action,

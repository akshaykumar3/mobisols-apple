...
/**
 * AbstractComponentVersionAll entity provides the base persistence definition
 * of the ComponentVersionAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractComponentVersionAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractComponentVersionAll() {
	}

	/** minimal constructor */
	public AbstractComponentVersionAll(UserAll userAll, Timestamp createdOn,
	...
	/** full constructor */
	public AbstractComponentVersionAll(ComponentAll componentAll,
			UserAll userAll, String description, String listOfChanges,

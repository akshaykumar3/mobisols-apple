...
/**
 * AbstractTollPriceAll entity provides the base persistence definition of the
 * TollPriceAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractTollPriceAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractTollPriceAll() {
	}

	/** minimal constructor */
	public AbstractTollPriceAll(TollLocationAll tollLocationAll,
			UserAll userAll, VehicleTypeAll vehicleTypeAll, String direction,
			Double costPrice, Double sellingPrice, Timestamp lastModifiedOn,
			Timestamp createdOn) {
	...
	/** full constructor */
	public AbstractTollPriceAll(ClientAll clientAll,
			TollLocationAll tollLocationAll, UserAll userAll,

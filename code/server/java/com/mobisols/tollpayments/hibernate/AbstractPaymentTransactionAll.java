...
/**
 * AbstractPaymentTransactionAll entity provides the base persistence definition
 * of the PaymentTransactionAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractPaymentTransactionAll extends GlobalToll
	...
	/** default constructor */
	public AbstractPaymentTransactionAll() {
	}

	/** minimal constructor */
	public AbstractPaymentTransactionAll(UserAll userAll, String status,
	...
	/** full constructor */
	public AbstractPaymentTransactionAll(ClientAll clientAll,

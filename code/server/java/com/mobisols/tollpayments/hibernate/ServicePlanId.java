...
/**
 * ServicePlanId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class ServicePlanId extends GlobalToll implements java.io.Serializable {
	...
	/** minimal constructor */
	public ServicePlanId(Integer servicePlanId, String name,
	...
	/** full constructor */
	public ServicePlanId(Integer servicePlanId, Integer tollOperatorId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ServicePlanId))
			return false;
		ServicePlanId castOther = (ServicePlanId) other;

		return ((this.getServicePlanId() == castOther.getServicePlanId()) || (this
				.getServicePlanId() != null
				&& castOther.getServicePlanId() != null && this
				.getServicePlanId().equals(castOther.getServicePlanId())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getServicePlanId() == null ? 0 : this.getServicePlanId()
						.hashCode());
		result = 37
				* result

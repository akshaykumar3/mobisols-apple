...
/**
 * AbstractVmlType entity provides the base persistence definition of the
 * VmlType entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractVmlType extends GlobalToll implements
		java.io.Serializable {

	// Fields

	private VmlTypeId id;

	// Constructors

	/** default constructor */
	public AbstractVmlType() {
	}

	/** full constructor */
	public AbstractVmlType(VmlTypeId id) {
		this.id = id;
	}
	...
	public VmlTypeId getId() {
		return this.id;
	}

	public void setId(VmlTypeId id) {
		this.id = id;
	}

...
/**
 * AbstractTollPriceHistoryAll entity provides the base persistence definition
 * of the TollPriceHistoryAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractTollPriceHistoryAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractTollPriceHistoryAll() {
	}

	/** minimal constructor */
	public AbstractTollPriceHistoryAll(Integer tollPriceId,
	...
	public AbstractTollPriceHistoryAll(Integer tollPriceId,
			...
			Integer clientId, Set<VehicleTollUsageAll> vehicleTollUsageAlls) {
		this.tollPriceId = tollPriceId;
		this.tollLocationId = tollLocationId;
		this.vehicleTypeId = vehicleTypeId;

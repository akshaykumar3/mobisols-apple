 ...
 */
@Embeddable
public class UserPaymentDetailId implements java.io.Serializable {
	...
	/** default constructor */
	public UserPaymentDetailId() {
	}

	/** minimal constructor */
	public UserPaymentDetailId(Integer updId, String payPrefer) {
		this.updId = updId;
		this.payPrefer = payPrefer;
	}

	/** full constructor */
	public UserPaymentDetailId(Integer updId, Integer userId, Integer ccTypeId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UserPaymentDetailId))
			return false;
		UserPaymentDetailId castOther = (UserPaymentDetailId) other;

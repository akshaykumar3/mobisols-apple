...
public class CcTypeId extends GlobalToll implements java.io.Serializable {
	...
	/** minimal constructor */
	public CcTypeId(Integer ccTypeId, Timestamp createdOn,
	...
	/** full constructor */
	public CcTypeId(Integer ccTypeId, String name, String description,
	...
	@Column(name = "cc_type_id", nullable = false)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CcTypeId))
			return false;
		CcTypeId castOther = (CcTypeId) other;

		return ((this.getCcTypeId() == castOther.getCcTypeId()) || (this
				.getCcTypeId() != null && castOther.getCcTypeId() != null && this

...
public class OwnerTypeId implements java.io.Serializable {
	...
	/** minimal constructor */
	public OwnerTypeId(Integer ownerTypeId, String name, Timestamp createdOn,
	...
	/** full constructor */
	public OwnerTypeId(Integer ownerTypeId, String name, String description,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OwnerTypeId))
			return false;
		OwnerTypeId castOther = (OwnerTypeId) other;

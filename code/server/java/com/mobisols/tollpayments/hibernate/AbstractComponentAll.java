...
/**
 * AbstractComponentAll entity provides the base persistence definition of the
 * ComponentAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractComponentAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractComponentAll() {
	}

	/** minimal constructor */
	public AbstractComponentAll(Integer componentId, UserAll userAll,
	...
	/** full constructor */
	public AbstractComponentAll(Integer componentId, ClientAll clientAll,
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "componentAll")

...
/**
 * AbstractTollOperatorAll entity provides the base persistence definition of
 * the TollOperatorAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractTollOperatorAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractTollOperatorAll() {
	}

	/** minimal constructor */
	public AbstractTollOperatorAll(UserAll userAllByLastModifiedBy,
	...
	/** full constructor */
	public AbstractTollOperatorAll(ClientAll clientAll,

 ...
 */
@Embeddable
public class TollPriceId extends GlobalToll implements java.io.Serializable {
	...
	/** minimal constructor */
	public TollPriceId(Integer tollPriceId, Integer tollLocationId,
			Integer vehicleTypeId, String direction, Double costPrice,
			Double sellingPrice, Integer lastModifiedBy,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TollPriceId))
			return false;
		TollPriceId castOther = (TollPriceId) other;

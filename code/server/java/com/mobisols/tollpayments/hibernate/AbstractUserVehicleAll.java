...
/**
 * AbstractUserVehicleAll entity provides the base persistence definition of the
 * UserVehicleAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractUserVehicleAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractUserVehicleAll() {
	}

	/** minimal constructor */
	public AbstractUserVehicleAll(UserAll userAllByLastModifiedBy,
	...
	/** full constructor */
	public AbstractUserVehicleAll(ClientAll clientAll,
			UserAll userAllByLastModifiedBy, OwnerTypeAll ownerTypeAll,
			UserAll userAllByUserId, VehicleTypeAll vehicleTypeAll,

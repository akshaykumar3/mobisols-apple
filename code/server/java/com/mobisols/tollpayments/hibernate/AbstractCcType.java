...
/**
 * AbstractCcType entity provides the base persistence definition of the CcType
 * entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractCcType extends GlobalToll implements
	...
	/** default constructor */
	public AbstractCcType() {
	}

	/** full constructor */
	public AbstractCcType(CcTypeId id) {
		this.id = id;
	}

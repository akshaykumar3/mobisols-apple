...
/**
 * AbstractUserPaymentDetail entity provides the base persistence definition of
 * the UserPaymentDetail entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractUserPaymentDetail extends GlobalToll implements
	...
	/** default constructor */
	public AbstractUserPaymentDetail() {
	}

	/** full constructor */
	public AbstractUserPaymentDetail(UserPaymentDetailId id) {
		this.id = id;
	}

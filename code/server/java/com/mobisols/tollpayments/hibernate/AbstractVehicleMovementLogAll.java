...
/**
 * AbstractVehicleMovementLogAll entity provides the base persistence definition
 * of the VehicleMovementLogAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractVehicleMovementLogAll extends GlobalToll
	...
	/** default constructor */
	public AbstractVehicleMovementLogAll() {
	}

	/** minimal constructor */
	public AbstractVehicleMovementLogAll(
			UserVehicleHistoryAll userVehicleHistoryAll, UserAll userAll,
			VmlTypeAll vmlTypeAll, String geometry, Timestamp lastModifiedOn,
			Timestamp createdOn) {

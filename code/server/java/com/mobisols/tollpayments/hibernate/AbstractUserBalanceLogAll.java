...
/**
 * AbstractUserBalanceLogAll entity provides the base persistence definition of
 * the UserBalanceLogAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractUserBalanceLogAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractUserBalanceLogAll() {
	}

	/** minimal constructor */
	public AbstractUserBalanceLogAll(UserBalanceAll userBalanceAll,
			Double delta, String action, Timestamp lastModifiedOn,
			Timestamp createdOn) {
	...
	/** full constructor */
	public AbstractUserBalanceLogAll(ClientAll clientAll,

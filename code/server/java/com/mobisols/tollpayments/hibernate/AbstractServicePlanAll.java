...
/**
 * AbstractServicePlanAll entity provides the base persistence definition of the
 * ServicePlanAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractServicePlanAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractServicePlanAll() {
	}

	/** minimal constructor */
	public AbstractServicePlanAll(UserAll userAll, String name,
	...
	/** full constructor */
	public AbstractServicePlanAll(ClientAll clientAll, UserAll userAll,

...
/**
 * AbstractUserType entity provides the base persistence definition of the
 * UserType entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractUserType extends GlobalToll implements
	...
	/** full constructor */
	public AbstractUserType(UserTypeId id) {
		this.id = id;
	}

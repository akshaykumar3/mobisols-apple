...
/**
 * AbstractUserVehicleHistory entity provides the base persistence definition of
 * the UserVehicleHistory entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractUserVehicleHistory extends GlobalToll implements
	...
	/** default constructor */
	public AbstractUserVehicleHistory() {
	}

	/** full constructor */
	public AbstractUserVehicleHistory(UserVehicleHistoryId id) {
		this.id = id;
	}

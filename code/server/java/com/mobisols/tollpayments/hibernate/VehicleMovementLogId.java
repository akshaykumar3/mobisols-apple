 ...
 */
@Embeddable
public class VehicleMovementLogId implements java.io.Serializable {
	...
	/** full constructor */
	public VehicleMovementLogId(Integer vmlId, Integer vmlTypeId,
			Integer uvhId, String geometry, Timestamp timestamp, String udf1,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VehicleMovementLogId))
			return false;
		VehicleMovementLogId castOther = (VehicleMovementLogId) other;

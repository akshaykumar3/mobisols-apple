...
/**
 * AbstractPaymentTransaction entity provides the base persistence definition of
 * the PaymentTransaction entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractPaymentTransaction extends GlobalToll implements
	...
	/** default constructor */
	public AbstractPaymentTransaction() {
	}

	/** full constructor */
	public AbstractPaymentTransaction(PaymentTransactionId id) {
		this.id = id;
	}

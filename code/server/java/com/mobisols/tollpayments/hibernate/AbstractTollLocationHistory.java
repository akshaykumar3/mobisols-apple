...
/**
 * AbstractTollLocationHistory entity provides the base persistence definition
 * of the TollLocationHistory entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractTollLocationHistory extends GlobalToll implements
	...
	/** default constructor */
	public AbstractTollLocationHistory() {
	}

	/** full constructor */
	public AbstractTollLocationHistory(TollLocationHistoryId id) {
		this.id = id;
	}

...
/**
 * VehicleTypeId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class VehicleTypeId extends GlobalToll implements java.io.Serializable {
	...
	/** minimal constructor */
	public VehicleTypeId(Integer vehicleTypeId, String name,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VehicleTypeId))
			return false;
		VehicleTypeId castOther = (VehicleTypeId) other;

		return ((this.getVehicleTypeId() == castOther.getVehicleTypeId()) || (this
				.getVehicleTypeId() != null
				&& castOther.getVehicleTypeId() != null && this
				.getVehicleTypeId().equals(castOther.getVehicleTypeId())))

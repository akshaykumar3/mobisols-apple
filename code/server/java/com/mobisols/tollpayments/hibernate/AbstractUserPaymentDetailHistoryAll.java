...
/**
 * AbstractUserPaymentDetailHistoryAll entity provides the base persistence
 * definition of the UserPaymentDetailHistoryAll entity. @author MyEclipse
 * Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractUserPaymentDetailHistoryAll extends GlobalToll
	...
	/** default constructor */
	public AbstractUserPaymentDetailHistoryAll() {
	}

	/** minimal constructor */
	public AbstractUserPaymentDetailHistoryAll(String action,
	...
	/** full constructor */
	public AbstractUserPaymentDetailHistoryAll(Integer updId, Integer userId,

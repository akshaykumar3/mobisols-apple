...
/**
 * AbstractVehicleTollUsage entity provides the base persistence definition of
 * the VehicleTollUsage entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractVehicleTollUsage extends GlobalToll implements
	...
	/** default constructor */
	public AbstractVehicleTollUsage() {
	}

	/** full constructor */
	public AbstractVehicleTollUsage(VehicleTollUsageId id) {
		this.id = id;
	}

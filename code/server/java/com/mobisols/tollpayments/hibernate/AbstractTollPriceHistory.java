...
/**
 * AbstractTollPriceHistory entity provides the base persistence definition of
 * the TollPriceHistory entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractTollPriceHistory extends GlobalToll implements
	...
	/** default constructor */
	public AbstractTollPriceHistory() {
	}

	/** full constructor */
	public AbstractTollPriceHistory(TollPriceHistoryId id) {
		this.id = id;
	}

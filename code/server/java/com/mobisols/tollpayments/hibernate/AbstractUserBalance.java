...
/**
 * AbstractUserBalance entity provides the base persistence definition of the
 * UserBalance entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractUserBalance extends GlobalToll implements
	...
	/** default constructor */
	public AbstractUserBalance() {
	}

	/** full constructor */
	public AbstractUserBalance(UserBalanceId id) {
		this.id = id;
	}

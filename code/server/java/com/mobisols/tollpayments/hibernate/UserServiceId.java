 ...
 */
@Embeddable
public class UserServiceId extends GlobalToll implements java.io.Serializable {
	...
	/** minimal constructor */
	public UserServiceId(Integer userServiceId, Timestamp startDate,
	...
	/** full constructor */
	public UserServiceId(Integer userServiceId, Integer userId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UserServiceId))
			return false;
		UserServiceId castOther = (UserServiceId) other;

...
public class TollPriceHistoryId extends GlobalToll implements
	...
	/** default constructor */
	public TollPriceHistoryId() {
	}

	/** minimal constructor */
	public TollPriceHistoryId(Integer tphId, Integer tollPriceId,
	...
	@Column(name = "tph_id", nullable = false)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TollPriceHistoryId))
			return false;
		TollPriceHistoryId castOther = (TollPriceHistoryId) other;

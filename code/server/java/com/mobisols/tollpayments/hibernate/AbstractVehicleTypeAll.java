...
/**
 * AbstractVehicleTypeAll entity provides the base persistence definition of the
 * VehicleTypeAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractVehicleTypeAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractVehicleTypeAll() {
	}

	/** minimal constructor */
	public AbstractVehicleTypeAll(UserAll userAll, String name,
	...
	/** full constructor */
	public AbstractVehicleTypeAll(ClientAll clientAll, UserAll userAll,

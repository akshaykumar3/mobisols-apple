...
/**
 * AbstractTollLocationAll entity provides the base persistence definition of
 * the TollLocationAll entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractTollLocationAll extends GlobalToll implements
	...
	/** default constructor */
	public AbstractTollLocationAll() {
	}

	/** minimal constructor */
	public AbstractTollLocationAll(Integer tollLocationId, UserAll userAll,
	...
	/** full constructor */
	public AbstractTollLocationAll(Integer tollLocationId, ClientAll clientAll,

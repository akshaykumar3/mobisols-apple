...
/**
 * AbstractUserPaymentDetailHistory entity provides the base persistence
 * definition of the UserPaymentDetailHistory entity. @author MyEclipse
 * Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractUserPaymentDetailHistory extends GlobalToll
	...
	/** default constructor */
	public AbstractUserPaymentDetailHistory() {
	}

	/** full constructor */
	public AbstractUserPaymentDetailHistory(UserPaymentDetailHistoryId id) {
		this.id = id;
	}

...
/**
 * AbstractTollOperator entity provides the base persistence definition of the
 * TollOperator entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractTollOperator extends GlobalToll implements
	...
	/** default constructor */
	public AbstractTollOperator() {
	}

	/** full constructor */
	public AbstractTollOperator(TollOperatorId id) {
		this.id = id;
	}

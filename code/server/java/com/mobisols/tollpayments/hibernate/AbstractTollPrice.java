...
/**
 * AbstractTollPrice entity provides the base persistence definition of the
 * TollPrice entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractTollPrice extends GlobalToll implements
	...
	/** default constructor */
	public AbstractTollPrice() {
	}

	/** full constructor */
	public AbstractTollPrice(TollPriceId id) {
		this.id = id;
	}

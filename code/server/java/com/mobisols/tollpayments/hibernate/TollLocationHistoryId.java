 ...
 */
@Embeddable
public class TollLocationHistoryId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TollLocationHistoryId))
			return false;
		TollLocationHistoryId castOther = (TollLocationHistoryId) other;

...
public class CcType implements java.io.Serializable {
	...
	/** minimal constructor */
	public CcType(Integer ccTypeId, Timestamp createdOn,
	...
	/** full constructor */
	public CcType(Integer ccTypeId, String name, String description,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CcType))
			return false;
		CcType castOther = (CcType) other;

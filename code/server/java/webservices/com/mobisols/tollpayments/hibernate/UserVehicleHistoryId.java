 ...
 */
@Embeddable
public class UserVehicleHistoryId implements java.io.Serializable {
	...
	/** default constructor */
	public UserVehicleHistoryId() {
	}

	/** minimal constructor */
	public UserVehicleHistoryId(Integer uvhId, Integer userId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UserVehicleHistoryId))
			return false;
		UserVehicleHistoryId castOther = (UserVehicleHistoryId) other;

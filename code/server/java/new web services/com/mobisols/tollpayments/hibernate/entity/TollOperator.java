...
public class TollOperator implements java.io.Serializable {
	...
	/** minimal constructor */
	public TollOperator(Integer tollOperatorId, String name, String isActive,
	...
	/** full constructor */
	public TollOperator(Integer tollOperatorId, Integer userId, String name,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TollOperator))
			return false;
		TollOperator castOther = (TollOperator) other;

...
CREATE  TABLE IF NOT EXISTS `globaltoll`.`toll_location_all` (
  ...
  `geometry` GEOMETRY NULL COMMENT 'Geometrical values  of the location' ,
  ...
  `type` VARCHAR(30) NULL COMMENT 'toll booth/check point' ,
...
CREATE  TABLE IF NOT EXISTS `globaltoll`.`vehicle_movement_log_all` (
  ...
  `latitude` DECIMAL(9,6) NULL ,
  `longitude` DECIMAL(9,6) NULL ,
  `status` VARCHAR(45) NULL COMMENT 'tentative/paid' ,
  PRIMARY KEY (`vml_id`) ,
  ...
  INDEX `fk_vml_toll_location` (`toll_location_id` ASC) ,
  ...
  CONSTRAINT `fk_client_vml`
    ...
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_vml_toll_location`
...
CREATE  TABLE IF NOT EXISTS `globaltoll`.`toll_price_all` (
  ...
  UNIQUE INDEX `uk_tl_vt_dir` (`toll_location_id` ASC, `vehicle_type_id` ASC) ,
...
-- -----------------------------------------------------
-- Table `globaltoll`.`user_notification_type_all`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `globaltoll`.`user_notification_type_all` ;

CREATE  TABLE IF NOT EXISTS `globaltoll`.`user_notification_type_all` (
  `user_notification_type_id` INT NOT NULL AUTO_INCREMENT ,
  ...
  INDEX `fk_last_mod_by_not_type` (`last_modified_by` ASC) ,
  INDEX `fk_user_noti_type_client_all` (`client_id` ASC) ,
  CONSTRAINT `fk_last_mod_by_not_type`
    FOREIGN KEY (`last_modified_by` )
    REFERENCES `globaltoll`.`user_all` (`user_id` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_user_noti_type_client_all`
    FOREIGN KEY (`client_id` )
    REFERENCES `globaltoll`.`client_all` (`client_id` )
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `globaltoll`.`user_notification_all`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `globaltoll`.`user_notification_all` ;

CREATE  TABLE IF NOT EXISTS `globaltoll`.`user_notification_all` (
  `user_notification_id` INT NOT NULL AUTO_INCREMENT ,
  `user_id` INT NULL ,
  `user_notification_type_id` INT NULL ,
  ...
  INDEX `fk_user_all` (`user_id` ASC) ,
  INDEX `fk_user_notification_type_all` (`user_notification_type_id` ASC) ,
  INDEX `fk_last_mod_by_notification` (`last_modified_by` ASC) ,
  INDEX `fk_unotify_client_all` (`client_id` ASC) ,
  CONSTRAINT `fk_user_all`
    FOREIGN KEY (`user_id` )
    REFERENCES `globaltoll`.`user_all` (`user_id` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_user_notification_type_all`
    FOREIGN KEY (`user_notification_type_id` )
    REFERENCES `globaltoll`.`user_notification_type_all` (`user_notification_type_id` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_last_mod_by_notification`
    FOREIGN KEY (`last_modified_by` )
    REFERENCES `globaltoll`.`user_all` (`user_id` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_unotify_client_all`
    FOREIGN KEY (`client_id` )
    REFERENCES `globaltoll`.`client_all` (`client_id` )
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `globaltoll`.`user_notification_settings_all`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `globaltoll`.`user_notification_settings_all` ;

CREATE  TABLE IF NOT EXISTS `globaltoll`.`user_notification_settings_all` (
  `user_notification_settings_id` INT NOT NULL AUTO_INCREMENT ,
  `user_id` INT NULL ,
  `user_notification_type_id` INT NULL ,
  `udf1` VARCHAR(500) NULL ,
  `udf2` VARCHAR(500) NULL ,
  ...
  UNIQUE INDEX `index_user_notification` (`user_id` ASC, `user_notification_type_id` ASC) ,
  INDEX `fk_not_settings_user_all` (`user_id` ASC) ,
  INDEX `fk_settings_user_notification_type_all` (`user_notification_type_id` ASC) ,
  INDEX `fk_last_mod_by_notify_settings` (`last_modified_by` ASC) ,
  INDEX `fk_not_settings_client_all` (`client_id` ASC) ,
  CONSTRAINT `fk_not_settings_user_all`
    FOREIGN KEY (`user_id` )
    REFERENCES `globaltoll`.`user_all` (`user_id` )
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_settings_user_notification_type_all`
    FOREIGN KEY (`user_notification_type_id` )
    REFERENCES `globaltoll`.`user_notification_type_all` (`user_notification_type_id` )
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_last_mod_by_notify_settings`
    FOREIGN KEY (`last_modified_by` )
    REFERENCES `globaltoll`.`user_all` (`user_id` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_not_settings_client_all`
    FOREIGN KEY (`client_id` )
    REFERENCES `globaltoll`.`client_all` (`client_id` )
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `globaltoll`.`road_all`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `globaltoll`.`road_all` ;

CREATE  TABLE IF NOT EXISTS `globaltoll`.`road_all` (
  `road_id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(50) NULL ,
  `type` VARCHAR(30) NULL ,
  `start_location` VARCHAR(70) NULL ,
  `end_location` VARCHAR(70) NULL ,
  `udf1` VARCHAR(500) NULL ,
  `udf2` VARCHAR(500) NULL ,
  `udf3` VARCHAR(500) NULL ,
  `udf4` VARCHAR(500) NULL ,
  ...
  `client_id` INT NULL ,
  PRIMARY KEY (`road_id`) ,
  INDEX `fk_last_mod_by_road` (`last_modified_by` ASC) ,
  INDEX `fk_road_client_all` (`client_id` ASC) ,
  CONSTRAINT `fk_last_mod_by_road`
    FOREIGN KEY (`last_modified_by` )
    REFERENCES `globaltoll`.`user_all` (`user_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_road_client_all`
    FOREIGN KEY (`client_id` )
    REFERENCES `globaltoll`.`client_all` (`client_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `globaltoll`.`toll_location` (`toll_location_id` INT, `toll_operator_id` INT, `geometry` INT, `is_covered` INT, `is_cash_only` INT, `address1` INT, `address2` INT, `city` INT, `state` INT, `country` INT, `zip` INT, `udf1` INT, `udf2` INT, `udf3` INT, `udf4` INT, `udf5` INT, `flag1` INT, `flag2` INT, `flag3` INT, `flag4` INT, `flag5` INT, `last_modified_by` INT, `last_modified_on` INT, `created_on` INT, `client_id` INT, `latitude` INT, `longitude` INT, `direction` INT, `type` INT);

-- -----------------------------------------------------
-- Placeholder table for view `globaltoll`.`toll_price`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `globaltoll`.`toll_price` (`toll_price_id` INT, `toll_location_id` INT, `vehicle_type_id` INT, `cost_price` INT, `selling_price` INT, `udf1` INT, `udf2` INT, `udf3` INT, `udf4` INT, `udf5` INT, `flag1` INT, `flag2` INT, `flag3` INT, `flag4` INT, `flag5` INT, `last_modified_by` INT, `last_modified_on` INT, `created_on` INT, `client_id` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `globaltoll`.`vehicle_movement_log` (`vml_id` INT, `vml_type_id` INT, `uvh_id` INT, `toll_location_id` INT, `geometry` INT, `timestamp` INT, `udf1` INT, `udf2` INT, `udf3` INT, `udf4` INT, `udf5` INT, `flag1` INT, `flag2` INT, `flag3` INT, `flag4` INT, `flag5` INT, `last_modified_on` INT, `last_modified_by` INT, `created_on` INT, `client_id` INT, `latitude` INT, `longitude` INT, `status` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `globaltoll`.`toll_location_history` (`tlh_id` INT, `toll_location_id` INT, `toll_operator_id` INT, `geometry` INT, `is_covered` INT, `is_cash_only` INT, `address1` INT, `address2` INT, `city` INT, `state` INT, `country` INT, `zip` INT, `udf1` INT, `udf2` INT, `udf3` INT, `udf4` INT, `udf5` INT, `flag1` INT, `flag2` INT, `flag3` INT, `flag4` INT, `flag5` INT, `created_on` INT, `last_modified_on` INT, `last_modified_by` INT, `start_date` INT, `end_date` INT, `action` INT, `client_id` INT, `latitude` INT, `longitude` INT);
...
-- -----------------------------------------------------
-- Placeholder table for view `globaltoll`.`user_notification_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `globaltoll`.`user_notification_type` (`user_notification_type_id` INT, `notification_type` INT, `description` INT, `udf1` INT, `udf2` INT, `udf3` INT, `udf4` INT, `udf5` INT, `flag1` INT, `flag2` INT, `flag3` INT, `flag4` INT, `flag5` INT, `created_on` INT, `last_modified_on` INT, `last_modified_by` INT, `client_id` INT);

-- -----------------------------------------------------
-- Placeholder table for view `globaltoll`.`user_notification`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `globaltoll`.`user_notification` (`user_notification_id` INT, `user_id` INT, `user_notification_type_id` INT, `timestamp` INT, `description` INT, `udf1` INT, `udf2` INT, `udf3` INT, `udf4` INT, `udf5` INT, `flag1` INT, `flag2` INT, `flag3` INT, `flag4` INT, `flag5` INT, `created_on` INT, `last_modified_on` INT, `last_modified_by` INT, `client_id` INT);

-- -----------------------------------------------------
-- Placeholder table for view `globaltoll`.`user_notification_settings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `globaltoll`.`user_notification_settings` (`user_notification_settings_id` INT, `user_id` INT, `user_notification_type_id` INT, `udf1` INT, `udf2` INT, `udf3` INT, `udf4` INT, `udf5` INT, `flag1` INT, `flag2` INT, `flag3` INT, `flag4` INT, `flag5` INT, `created_on` INT, `last_modified_on` INT, `last_modified_by` INT, `client_id` INT);

-- -----------------------------------------------------
-- Placeholder table for view `globaltoll`.`road`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `globaltoll`.`road` (`road_id` INT, `name` INT, `type` INT, `start_location` INT, `end_location` INT, `udf1` INT, `udf2` INT, `udf3` INT, `udf4` INT, `udf5` INT, `flag1` INT, `flag2` INT, `flag3` INT, `flag4` INT, `flag5` INT, `created_on` INT, `last_modified_on` INT, `last_modified_by` INT, `client_id` INT);
...
-- -----------------------------------------------------
-- View `globaltoll`.`user_notification_type`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `globaltoll`.`user_notification_type` ;
DROP TABLE IF EXISTS `globaltoll`.`user_notification_type`;
USE `globaltoll`;
CREATE  OR REPLACE VIEW `globaltoll`.`user_notification_type` AS
select * from user_notification_type_all;

-- -----------------------------------------------------
-- View `globaltoll`.`user_notification`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `globaltoll`.`user_notification` ;
DROP TABLE IF EXISTS `globaltoll`.`user_notification`;
USE `globaltoll`;
CREATE  OR REPLACE VIEW `globaltoll`.`user_notification` AS
select * from user_notification_all;

-- -----------------------------------------------------
-- View `globaltoll`.`user_notification_settings`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `globaltoll`.`user_notification_settings` ;
DROP TABLE IF EXISTS `globaltoll`.`user_notification_settings`;
USE `globaltoll`;
CREATE  OR REPLACE VIEW `globaltoll`.`user_notification_settings` AS
select * from user_notification_settings_all;

-- -----------------------------------------------------
-- View `globaltoll`.`road`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `globaltoll`.`road` ;
DROP TABLE IF EXISTS `globaltoll`.`road`;
USE `globaltoll`;
CREATE  OR REPLACE VIEW `globaltoll`.`road` AS
select * from road_all;

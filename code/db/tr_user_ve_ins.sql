create trg_user_vehicle_aft_ins after insert on user_vehicle_all  as
start transaction;
...
new.udf1,new.udf2,new.udf3,new.udf4,new.udf5,new.flag1,new.flag2,new.flag3,new.flag4,new.flag5,new.created_on,new.last_modified_on,new.last_modified_by,new.start_date,new.end_date,''));

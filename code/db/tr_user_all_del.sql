create trg_user_all_on_del 
before delete on user_all as
start transaction;
update user_history
set end_date = sysdate()-'1 sec'
where 
user_id = new.user_id
...
values(null,new.user_id,new.user_name,new.password,new.locale,new.utype_id,new.last_login_time,new.is_active,new.contact_no,new.client_id,new.action,

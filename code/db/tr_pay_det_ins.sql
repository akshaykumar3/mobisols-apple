create trg_user_payment_aft_ins after insert on user_payment_detail_all as
start transaction;
...
new.city,new.state,new.country,new.zip,new.pay_prefer,'',new.udf1,new.udf2,new.udf3,new.udf4,new.udf5,new.flag1,new.flag2,new.flag3,new.flag4,new.flag5,new.created_on,
